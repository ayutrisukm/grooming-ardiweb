    ...
    <div class="container ">
        ...
        <div class="content">
              <ul class="list-group col-md-3 col-xs-2">
                <li class="list-group-item "><a href="http://localhost/groming/admin/index.php?mod=data"> <i class="fa fa-address-card "></i> <span class="hidden-xs">Data Grooming</span></a></li>
                </ul>
